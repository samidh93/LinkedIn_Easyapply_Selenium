...
class EasyApplyLinkedin:
    ...
    def job_search(self):
        ...
        search_keywords = self.driver.find_element_by_xpath('//*[@class="jobs-search-box__text-input jobs-search-box__keyboard-text-input"]')
        #search_keywords.clear()
        search_keywords.send_keys(self.keywords)
        search_location = self.driver.find_element_by_xpath('//*[@class="jobs-search-box__text-input"]')
